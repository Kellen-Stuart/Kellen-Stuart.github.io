...
function CharacterSheet() {
  return (
    <div id="character-sheet" class="container print-hide">
      <div id="stardew-border" class="stardew-border">
        <div class="row">
          <div id="portrait" class="col-3">
            <img
              class="img-fluid"
              src="kellen-stardew-portrait-dalle.webp"
            />
            <span class="stardew-text">Kellen Stuart</span>
          </div>
          <div id="stats" class="col-9">
            {/* .NET Core */}
            <div class="row mt-2">
            ...
            <div class="row mt-2">
              ...
              <div class="col-9">
                ...
                />
                <img class="img-fluid exp-sprite" src="number-8.png" />
              </div>
            </div>
            ...
            <div class="row mt-2">
              ...
              <div class="col-9">
                ...
                <img
                  ...
                  src="exp-sprite-4.png"
                />
                <img class="img-fluid exp-sprite" src="number-6.png" />
              </div>
            </div>
            ...
            <div class="row mt-2">
              <div class="col-3 d-flex align-items-center justify-content-end">
                ...
                />
                <img
                  class="img-fluid exp-sprite-triple-wide"
            ...
            <div class="row mt-2">
              <div class="col-3 d-flex align-items-center justify-content-end">
                <span class="stardew-text-no-border">Experience</span>
              </div>
              <div class="col-9">
                <img
                  class="img-fluid exp-sprite"
                ...
                />
                <img
                  class="img-fluid exp-sprite-super-wide"
                  src="8-years.png"
                />
              </div>
            </div>
